        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column  mx-2">
                    ...
                    <?php if (isset($_SESSION['paket_id'])) : ?>

                        <div class="fs-5 ms-3"><?= $_SESSION['paket_name']; ?></div>

                        <li class="nav-item">
                            <form action="<?= BASEURL; ?>/paket/manage/switch" method="post">
                                <input type="hidden" name="paket_id" value=null>
