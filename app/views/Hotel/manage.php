...
<body>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column  mx-2">
                        <li class="nav-item">
                            <a class="nav-link fs-6 mb-3" aria-current="page" href="<?= BASEURL; ?>/">
                                <span data-feather="home" class="align-text-bottom"></span>
                                Home
                            </a>
                        </li>
                        <div class="fs-6">Select Hotel:</div>
                        <li class="nav-item">
                            <select class="form-select" aria-label="Default select example" name="hotel_id" id="selhotel_id">
    ...
    <script>
        // var select = document.querySelector('#selhotel_id');
        //         var optSelected = $("")
        // console.log(select);
        $("#selhotel_id").on('change', function(e) {
